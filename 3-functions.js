...
console.log(array(number, number2));
...
function findPositiveNumbers(arr1, a) {
...
console.log(findPositiveNumbers(arr, a1));
...
function getRandomRGB(){
    ...
    let g1 = getRandomInteger(0, 255);

    let b1 = getRandomInteger(0, 255);
